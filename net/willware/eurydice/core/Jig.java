...
//import net.willware.eurydice.forcefields.mm2.NanocadStyleMM2;
...
public abstract class Jig {
     ...
     * @return the jig
     */
    public static Jig getJig(Structure struc, String jigName) {
        // handle simple jigs
        // handle force fields
        try {
            ...
            Jig j = (Jig) Class.forName(jigName).newInstance();
